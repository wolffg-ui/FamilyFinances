...
let gen = (function* _initGenerator () {
  ...
  postReturn1 = exports1['cabi_post_extract-imports'];
  postReturn2 = exports1['cabi_post_parse-dist-metadata'];
  postReturn3 = exports1['cabi_post_parse-record'];
  postReturn4 = exports1['cabi_post_parse-direct-url'];
  postReturn5 = exports1['cabi_post_normalize-package-name'];
  postReturn6 = exports1['cabi_post_parse-requirements-txt'];
  postReturn7 = exports1['cabi_post_parse-pep508'];
  ...
  let exports1ExtractImports;
  
  function extractImports(arg0) {
    var ptr0 = utf8Encode(arg0, realloc0, memory0);
    var len0 = utf8EncodedLen;
    _debugLog('[iface="extract-imports", function="extract-imports"][Instruction::CallWasm] enter', {
      funcName: 'extract-imports',
      paramCount: 2,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'exports1ExtractImports');
    const ret = exports1ExtractImports(ptr0, len0);
    endCurrentTask(0);
    var len7 = dataView(memory0).getUint32(ret + 4, true);
    var base7 = dataView(memory0).getUint32(ret + 0, true);
    var result7 = [];
    for (let i = 0; i < len7; i++) {
      const base = base7 + i * 28;
      let variant2;
      ...
      var len4 = dataView(memory0).getUint32(base + 20, true);
      var base4 = dataView(memory0).getUint32(base + 16, true);
      var result4 = [];
      ...
      var bool5 = dataView(memory0).getUint8(base + 24, true);
      var bool6 = dataView(memory0).getUint8(base + 25, true);
      result7.push({
        module: variant2,
        level: clampGuest(dataView(memory0).getUint8(base + 12, true), 0, 255),
        names: result4,
        isModuleLevel: bool5 == 0 ? false : (bool5 == 1 ? true : throwInvalidBool()),
        inTypeChecking: bool6 == 0 ? false : (bool6 == 1 ? true : throwInvalidBool()),
      });
    }
    _debugLog('[iface="extract-imports", function="extract-imports"][Instruction::Return]', {
      funcName: 'extract-imports',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  exports1ExtractImports = exports1['extract-imports'];
  ...
  return { containsTopLevelCallable, evaluateMarker, extractImports, findAppOrHandler, getStringConstant, isWheelCompatible, normalizePackageName, parseDirectUrl, parseDistMetadata, parsePep508, parseRecord, parseRequirementsTxt,  };
})();
