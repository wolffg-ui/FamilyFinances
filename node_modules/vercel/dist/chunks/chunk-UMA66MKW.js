...
var addScopeOptions = [
  {
    ...scopeOptions[0],
    description: "Target project when the body omits projectId; built-in rules otherwise remain team-wide."
  },
  scopeOptions[1]
];
  ...
  options: [
    {
      ...
      argument: "TYPE",
      deprecated: false,
      description: "Alert rule type to describe: usage_anomaly, error_anomaly, or custom_alert."
    },
    formatOption
  ],
  examples: [
...
var rulesUpdateSubcommand = {
  ...
  options: [
    ...
    jsonOption,
    {
      ...
      argument: "PATH",
      deprecated: false,
      description: "Path to partial JSON. Omitted fields remain unchanged; null clears supported optional fields."
    }
  ],
  examples: [
    {
