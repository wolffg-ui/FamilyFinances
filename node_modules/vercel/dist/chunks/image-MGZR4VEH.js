...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-FI4MV46I.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-KQBV3ALQ.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-E2WEJZPW.js")).default(client, args, telemetry);
    default:
